...
const CLOUDINARY_CLOUD = process.env.CLOUDINARY_CLOUD_NAME || 'dkoyl1oz8';
const CLOUDINARY_KEY = process.env.CLOUDINARY_API_KEY || '268934121615586';
const CLOUDINARY_SECRET = process.env.CLOUDINARY_API_SECRET || 'jyErA75bPMYHTP_Kz5XQL5Gdxlk';
